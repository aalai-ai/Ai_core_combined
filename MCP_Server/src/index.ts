  ...
  if (name === "generate_3d_prompt") {
    ...
    try {
      ...
      if (!dimensions) {
        ...
        dimensions = {
          modelName: query || "Schneider Electric EasyLogic™ EM6436H LED",
          ...
          mechanical: {
            ...
            height_mm: 96.0,
            depth_mm: 101.5,
            bezelThickness_mm: 13.9,
            bezelDepth_mm: 13.9,
            secondaryBody_mm: 90.5,
            bodyDepth_mm: 87.6,
            depthBehindPanel_mm: 48.8,
            panelCutoutWidth_mm: 92.0,
            panelCutoutHeight_mm: 92.0,
            maxPanelThickness_mm: 5.0,
          ...
          terminals: {
            ...
            screwType: "Phillips/Pan-head Recessed Screw",
            silkscreenLabels: [
              "V1", "V2", "V3", "VN",
              "L1", "L2",
              "I1+", "I1-", "I2+", "I2-", "I3+", "I3-",
          ...
          displayAndControls: {
            screenWidth_mm: 58.0,
            screenHeight_mm: 65.0,
            screenInsetDepth_mm: 2.0,
            displayType: "3 rows × 4-digit 8-segment LED + 12-LED Analog Load Bar",
            buttonCount: 4,
            buttonDiameter_mm: 6.5,
            buttonReliefHeight_mm: 1.2,
            buttonMarkings: ["Left", "Down (Lock)", "Up", "OK/Enter"],
            ledCount: 2,
            ledDiameter_mm: 3.0,
            ledColors: ["Red (Pulse)", "Green (Heartbeat/ECG)"],
          },
          materialsAndShaders: {
            bodyColorHex: "#5A5D61",
            bodyMaterial: "Matte Graphite Gray Plastic",
            bodyRoughness: 0.55,
            bezelColorHex: "#6B6E72",
            bezelRoughness: 0.50,
            screenLensMaterial: "Dark Unlit LED Glass",
            screenLensColor: "#3A0E0E",
            screenTransmission: 0.85,
            screenRoughness: 0.30,
            screenIOR: 1.45,
